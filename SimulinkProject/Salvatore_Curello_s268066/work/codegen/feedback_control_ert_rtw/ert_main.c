...
void rt_OneStep(RT_MODEL_feedback_control *const feedback_control_M)
{
  ...
  /* Step the model */
  feedback_control_step(feedback_control_M, feedback_control_U_echo_input,
                        &feedback_control_Y_level,
                        &feedback_control_Y_trigger_output);
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  feedback_control_initialize(feedback_control_M, &feedback_control_U_echo_input,
    &feedback_control_Y_level, &feedback_control_Y_trigger_output);
